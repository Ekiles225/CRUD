          ...
          <div class="aside-menu overflow-hidden">
            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
                ...
                <li class="menu-header">Erick Villa </li><!-- /.menu-header -->
                <!-- .menu-item -->
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                <div class="d-flex flex-column flex-md-row">
                  <p class="lead">
                    <span class="font-weight-bold">Hi, Erick.</span> <span class="d-block text-muted">Here’s what’s happening with your business today.</span>
                  </p>
                  <div class="ml-auto">
                    <!-- .dropdown -->
                    <div class="dropdown">
